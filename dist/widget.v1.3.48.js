...
(() => {
  ...
  (function() {
    ...
    const config = {
      ...
      /*  👉  NEU – nur starten, wenn data-auto-start="true"  */
    ...
    function injectThemeStyles() {
      ...
      /* Close Button Styling - integrated in header */
    ...
    function buildWidgetUI() {
      ...
      headerTitle.textContent = config.name && !config.name.includes("{{") ? config.name : "Assistant";
  ...
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
    ...
    window.VoiceSaasWidget = {
      version,
      /*  Manuell von außen aufrufbar  */
      load(customConfig = {}) {
        Object.assign(config, customConfig);
        runInitWhenDomReady();
      },
      /*  Legacy‑API behältst du, falls du zweite Widgets erzeugst  */
      createWidget(customConfig = {}) {
        Object.assign(config, customConfig);
        injectThemeStyles();
        return initWidget();
      }
