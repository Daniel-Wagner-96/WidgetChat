...
(() => {
  ...
  (function() {
    ...
    function injectThemeStyles() {
      ...
      :root {
        --vs-primary-color: ${config.themeColor};
      }
      ...
      /* 3D-Effekt f\xFCr den Mikro-Button */
    ...
    function buildWidgetUI() {
      ...
      if (window.Heroicons && Heroicons.xmark) {
        closeButton.innerHTML = Heroicons.xmark({ class: "h-5 w-5" });
      } else {
    ...
    async function initWidget() {
      ...
      if (window.Heroicons && Heroicons.microphone) {
        micButton.innerHTML = Heroicons.microphone({ class: "h-6 w-6" });
      } else {
